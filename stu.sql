...
INSERT INTO `cls` VALUES (1,'Lily',18,'w',100),(2,'Lucy',18,'w',95),(3,'Joy',19,'m',84),(4,'Tom',19,'m',89),(5,'Emma',17,'w',94),(6,'Jame',18,'m',72),(7,'Alex',18,'m',68);
...
INSERT INTO `cls_bak` VALUES (1,'Lily',18,'w',100),(2,'Lucy',18,'w',95),(3,'Joy',19,'m',84),(4,'Tom',19,'m',89),(5,'Emma',17,'w',94),(6,'Jame',18,'m',72),(7,'Alex',18,'m',68);
...
INSERT INTO `dept` VALUES (1,'技术部'),(2,'销售部'),(4,'行政部'),(5,'财务部'),(6,'市场部');
...
INSERT INTO `hobby` VALUES (1,'Joy','sing,dance',63800.00,NULL,'骨骼惊奇,练舞奇才'),(2,'Lily','sing',20000.00,NULL,'天籁之音'),(3,'Jame','draw',13800.00,NULL,'当代达芬奇');
...
INSERT INTO `marathon` VALUES (1,'阿尔法','1992-10-13','2020-01-08 08:28:45','02:40:36'),(2,'曹操','1998-11-20','2020-02-29 18:18:15','02:20:56'),(3,'尼古拉斯赵四','1996-05-20','2020-01-29 10:08:15','02:33:04'),(4,'许三多','1995-01-08','2020-08-03 11:50:36',NULL);
...
INSERT INTO `sanguo` VALUES (1,'曹操','男','魏',256,63),(2,'张辽','男','魏',328,69),(3,'甄姬','女','魏',168,34),(4,'夏侯渊','男','魏',366,83),(5,'刘备','男','蜀',220,59),(6,'诸葛亮','男','蜀',170,54),(7,'赵云','男','蜀',360,NULL),(8,'张飞','男','蜀',370,80),(9,'孙尚香','女','蜀',249,62),(10,'大乔','女','吴',190,44),(11,'小乔','女','吴',188,39),(12,'周瑜','男','吴',300,60),(13,'吕蒙','男','吴',300,71);
...
/*!50001 VIEW `good_student` AS select `cls`.`name` AS `name`,`cls`.`age` AS `age` from `cls` */;
...
-- Dump completed on 2020-08-07 14:35:39
